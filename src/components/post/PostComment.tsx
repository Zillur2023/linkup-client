...
const PostComment: React.FC<PostCommentProps> = ({ postId, openButtonText, comment, focusRef }) => {
  ...
  const [expandedComments, setExpandedComments] = useState<{ [key: string]: boolean }>({}); // State to manage expanded comments
            ...
            return (
               ...
               {editingComment?._id !== comment?._id ? (
                 ...
                 <div className="mt-2 flex items-center gap-4">
                   ...
                   <span className="text-gray-400 text-sm">{formatTime(comment?.createdAt)}</span>
